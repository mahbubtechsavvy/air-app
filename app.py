...
if st.session_state.view_data_clicked:
    ...
    st.markdown(f'<h3 style="color:#21263f;">Showing Data for: {st.session_state.country}, {st.session_state.state_region}, {st.session_state.city}</h3>', unsafe_allow_html=True)
