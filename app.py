...
# -----------------------------------------------------------------------------
st.markdown('<h1 style="text-align:center; color:white; font-size:40px;"><span style="font-weight:500;">Magick Board of</span><span style="font-weight:200; font-size:20px;"> Air 13x</span></h1>', unsafe_allow_html=True)
