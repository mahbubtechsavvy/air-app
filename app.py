...
# -----------------------------------------------------------------------------
st.markdown('<h1 style="text-align:center; color:white; font-size:40px;"><span style="font-weight:500;">  Magick Board ✨</span><span style="font-weight:200; font-size:15px;">🌍</span></h1>', unsafe_allow_html=True)
